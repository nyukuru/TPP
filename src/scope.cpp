...
constexpr std::array<std::pair<scope::scopes, const char *>, 81> scope_names {{
    ...
    {scope::s_moderator_manage_announcements, "moderator:manage:announcements"},
    {scope::s_moderator_manage_automod, "moderator:manage:automod"},
    {scope::s_moderator_manage_automod_settings, "moderator:manage:automod_settings"},
    {scope::s_moderator_manage_banned_users, "moderator:manage:banned_users"},
    {scope::s_moderator_manage_blocked_terms, "moderator:manage:blocked_terms"},
    {scope::s_moderator_manage_chat_messages, "moderator:manage:chat_messages"},
    {scope::s_moderator_manage_chat_settings, "moderator:manage:chat_settings"},
    ...
    {scope::s_moderator_manage_suspicious_users, "moderator:manage:suspicious_users"},
    {scope::s_moderator_manage_unban_requests, "moderator:manage:unban_requests"},
    {scope::s_moderator_manage_warnings, "moderator:manage:warnings"},
    {scope::s_moderator_read_automod_settings, "moderator:read:automod_settings"},
    ...
    {scope::s_moderator_read_suspicious_users, "moderator:read:suspicious_users"},
    {scope::s_moderator_read_unban_requests, "moderator:read:unban_requests"},
