 ...
 */
class TPP_EXPORT websocket_client : public ssl_connection {
  /**
 ...
 public:
   ...
   * @param _opcode The opcode of the data to send, either binary or text. The
   * default is to use the socket's opcode as set in the constructor.
   */
